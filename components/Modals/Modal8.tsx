import styles from './Modal8.module.scss';
...
export default function Modal8() {
  ...
  React.useEffect(() => {
    ...
    setImage('https://thumbsnap.com/i/RLStvi5Z.png');
    setLogo('');
  }, []);

  return (
    <div style={{ color: colors.color2, backgroundColor: colors.color1 }} className={`${styles.modal8} ${size === 'small' ? styles.small : size === 'medium' ? styles.medium : styles.large}`}>
