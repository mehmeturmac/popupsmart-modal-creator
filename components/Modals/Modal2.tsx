...
export default function Modal2() {
  const { size, colors, setImage, setLogo, contents, setContents } = React.useContext(MainContext) as MainContextInterface;
  ...
  return (
    <div style={{ color: colors.color2, backgroundColor: colors.color1 }} className={`${styles.modal2} ${size === 'small' ? styles.small : size === 'medium' ? styles.medium : styles.large}`}>
      ...
      <div className={styles.radioGroup}>
        ...
        <label htmlFor="radio3">
          <input type="radio" name="radioGroup" id="radio3" defaultChecked />
      ...
      <div className={styles.btnGroup}>
        ...
        <button style={{ color: 'rgba(255, 255, 255, 0.9)', backgroundColor: colors.color3 }}>{contents.content10}</button>
      </div>
    </div>
  );
}
