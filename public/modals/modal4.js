function Pop() {
  var cssRuleFile = 'http://localhost:3000/modals/modal4.css';
  ...
  let createPopUp = function () {
    if (typeof conDivObj === 'undefined') {
      ...
      conDivObj.setAttribute('id', 'modal4');
    }
    ...
    conDivObj.innerHTML = `
    <div style="color: ${colors.color2}; background-color: ${colors.color1};" id="modal4-popup" class="modal4-popup hide ${
    ...
    function actions() {
      ...
      const popup = document.getElementById('modal4-popup').classList;
