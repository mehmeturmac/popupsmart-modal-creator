function Pop() {
  var cssRuleFile = 'http://localhost:3000/modals/modal7.css';
  ...
  let contents = {
    ...
    content4: 'By subscribe this form I agree to Privacy Policy.',
    content5: 'Sign up now',
  };
  ...
  let createPopUp = function () {
    if (typeof conDivObj === 'undefined') {
      ...
      conDivObj.setAttribute('id', 'modal7');
    }
    ...
    conDivObj.innerHTML = `
    <div style="color: ${colors.color1}; background-color: ${colors.color3};" id="modal7-popup" class="modal7-popup hide ${
      ...
      <input type="text" id="popup-input" placeholder="${contents.content3}" style="color: ${colors.color1}; background-color: ${colors.color3};" />
      <label for="popup-checkbox">
        <input type="checkbox" id="popup-checkbox" />
        <span>${contents.content4}</span>
      </label>
      <div class="btnGroup">
        <button id="submitBtn" style="color: ${colors.color2}; background-color: ${colors.color1};">
          ${contents.content5}
        </button>
      </div>
    </div>`;
    ...
    function actions() {
      ...
      const popup = document.getElementById('modal7-popup').classList;
